...
import { AcademicDegree } from '../../../src/generated/prisma/client';
      ...
      create: [
        {
          person: {
            create: {
              name: 'Oskar',
              surname: 'Szkurłat',
              academicDegree: AcademicDegree.MasterOfScienceInEngineering,
            },
          },
        },
        {
        ...
        },
        {
          person: {
            create: {
              name: 'Marek',
              surname: 'Kciuk',
              academicDegree: AcademicDegree.DoctorInEngineering,
            },
          },
        },
        {
        ...
        },
        {
          person: {
            create: {
              name: 'Sebastian',
              surname: 'Budzan',
              academicDegree: AcademicDegree.HabilitatedDoctorInEngineering,
            },
          },
        },
      ],
