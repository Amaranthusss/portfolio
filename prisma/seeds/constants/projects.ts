			...
			create: [
				{
					...
					content: getProjectContent(ProjectSlug.ProductionSystemUtilizingAGV, Locale.pl)
				},
				{
					locale: Locale.en,
					name: 'Production Line Automation System Using AGV',
					content: getProjectContent(ProjectSlug.ProductionSystemUtilizingAGV, Locale.en)
				},
			],
		},
	},
			...
			create: [
				{
					...
					content: getProjectContent(ProjectSlug.AmaranthusAGVPlatform, Locale.pl)
				},
				{
					locale: Locale.en,
					name: 'AGV vehicle "Amaranthus" - Platform',
					content: getProjectContent(ProjectSlug.AmaranthusAGVPlatform, Locale.en)
				},
			],
		},
	},
			...
			create: [
				{
					...
					content: getProjectContent(ProjectSlug.ElectrohydraulicSystemControl, Locale.pl)
				},
				{
					locale: Locale.en,
					name: 'Electro-hydraulic System Control',
					content: getProjectContent(ProjectSlug.ElectrohydraulicSystemControl, Locale.en)
				},
			],
		},
	},
			...
			create: [
				{
					...
					content: getProjectContent(ProjectSlug.ControlOfAGVGestureVoice, Locale.pl)
				},
				{
					locale: Locale.en,
					name: 'AGV Control using Gesture Recognition and Voice Analysis',
					content: getProjectContent(ProjectSlug.ControlOfAGVGestureVoice, Locale.en)
				},
			],
		},
	},
			...
			create: [
				{
					...
					content: getProjectContent(ProjectSlug.CurriculumVitaeGenerator, Locale.pl)
				},
				{
					locale: Locale.en,
					name: 'Curriculum Vitae Generator',
					content: getProjectContent(ProjectSlug.CurriculumVitaeGenerator, Locale.en)
				},
			],
		},
	},
			...
			create: [
				{
					...
					content: getProjectContent(ProjectSlug.PilsudskiPalaceSmartHome, Locale.pl)
				},
				{
					locale: Locale.en,
					name: '"Piłsudski Palace" – Smart Home',
					content: getProjectContent(ProjectSlug.PilsudskiPalaceSmartHome, Locale.en)
				},
			],
		},
	},
			...
			create: [
				{
					...
					content: getProjectContent(ProjectSlug.PilsudskiPalaceProjectAndRealization, Locale.pl)
				},
				{
					locale: Locale.en,
					name: '"Piłsudski Palace" – Project and realization',
					content: getProjectContent(ProjectSlug.PilsudskiPalaceProjectAndRealization, Locale.en)
				},
			],
		},
	},
			...
			create: [
				{
					...
					content: getProjectContent(ProjectSlug.ArtisticLanguageNurseryLittleAcademy, Locale.pl)
				},
				{
					locale: Locale.en,
					name: 'Artistic and Language Nursery "Little Academy"',
					content: getProjectContent(ProjectSlug.ArtisticLanguageNurseryLittleAcademy, Locale.en)
				},
			],
		},
	},
