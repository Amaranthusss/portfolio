      ...
      create: [
        {
          ...
          description:
            'Kurs budowy skalowalnych, produkcyjnych aplikacji backend z użyciem mikroserwisów Nest.js.',
        },
        {
          locale: Locale.en,
          ...
          description:
            'A course on building scalable, production-ready backend applications using Nest.js microservices.',
        },
      ],
    },
  },
      ...
      create: [
        {
          ...
          description:
            'Kurs od podstaw, aż po deploy z wykorzystaniem Nest.js API z TypeScript, TypeORM, PostgreSQL oraz Docker.',
        },
        {
          locale: Locale.en,
          ...
          description:
            'A course from the basics all the way to deployment using a Nest.js API with TypeScript, TypeORM, PostgreSQL, and Docker.',
        },
      ],
    },
  },
      ...
      create: [
        {
          ...
          description:
            'Przejmij kontrolę nad uruchamianiem aplikacji Node.js, podłączając domeny do projektów i zarządzając serwerem VPS.',
        },
        {
          locale: Locale.en,
          ...
          description:
            'Take control of running Node.js applications by connecting domains to projects and managing a VPS server.',
        },
      ],
    },
  },
