...
import { PublicationSlug } from './publicationSlug';

export const publications: PublicationSeedData[] = [
  {
    ...
    authors: [
      {
        name: 'Oskar',
        surname: 'Szkurłat',
        academicDegree: 'MasterOfScienceInEngineering',
      },
      {
        name: 'Radosław',
        surname: 'Masłowski',
      ...
      },
      {
        name: 'Marek',
        surname: 'Kciuk',
        academicDegree: 'DoctorInEngineering',
      },
      {
        name: 'Roman',
        surname: 'Wyżgolik',
      ...
      },
      {
        name: 'Sebastian',
        surname: 'Budzan',
        academicDegree: 'HabilitatedDoctorInEngineering',
      },
    ],
