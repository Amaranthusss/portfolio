...
export function DisplaySkills({ skills, style, className }: DisplaySkillsProps): React.ReactNode {
	if (skills.length === 0) return null;

	const classNames = [className, styles.skill_list].filter(c => c != null).join(' ');
